...
channel_band_powers = [deque(maxlen=maxlen) for _ in range(32*3)]  

# Set up a figure with 32 subplots arranged in 4 rows and 8 columns
fig, axs = plt.subplots(32, 3, figsize=(16, 8))
lines = []
for ax in axs.flat:
...
plt.suptitle('Relative band power (32 Channels, theta, alpha, beta bands)')
plt.ion()
