...
class Subcribe():
    ...
    def on_new_eeg_data(self, *args, **kwargs):
        # Removed printing for EEG data
        pass

    def on_new_mot_data(self, *args, **kwargs):
        # Removed printing for motion data
        pass
    ...
    def on_new_pow_data(self, *args, **kwargs):
        # Removed printing for power data
        pass
...
def main():
    ...
    # If you don't need to subscribe to these streams at all, you can remove them from the list.
